...
from pcdet.ops.iou3d_nms import iou3d_nms_utils # type: ignore
...
class SigmoidFocalClassificationLoss(nn.Module):
    ...
    def forward(self, input: torch.Tensor, target: torch.Tensor, weights: torch.Tensor):
        ...
        # Reshape pred_sigmoid tensor to match the shape of target tensor along the second dimension
        pred_sigmoid_resized = torch.nn.functional.interpolate(pred_sigmoid, size=target.shape[1], mode='nearest')

# Check the new shape of pred_sigmoid tensor
        print("Resized shape of pred_sigmoid tensor:", pred_sigmoid_resized.shape)
