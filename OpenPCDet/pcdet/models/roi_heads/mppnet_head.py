...
class ProposalTargetLayerMPPNet(ProposalTargetLayer):
    ...
    def random_aug_box3d(self,box3d):
        ...
        if self.roi_sampler_cfg.REG_AUG_METHOD == 'single':
            ...
            return aug_box3d
        if self.roi_sampler_cfg.REG_AUG_METHOD == 'multiple':
            ...
            return aug_box3d
        if self.roi_sampler_cfg.REG_AUG_METHOD == 'normal':
...
class MPPNetHead(RoIHeadTemplate):
    ...
    @staticmethod
    def crop_current_frame_points(src, batch_size,trajectory_rois,num_rois,batch_dict):
