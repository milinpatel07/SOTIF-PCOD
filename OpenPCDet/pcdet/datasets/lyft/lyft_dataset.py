...
def create_lyft_info(version, data_path, save_path, split, max_sweeps=10):
    ...
    if version not in ['trainval', 'one_scene', 'test']:
    ...
    train_scenes = {available_scenes[available_scene_names.index(s)]['token'] for s in train_scenes}
